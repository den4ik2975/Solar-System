...
Чем шакальнее интереснее, тем лучше. Можно сделать 3D-анаглиф или придумать странную функцию, которая модулирует текстурные координаты, как я показывал на лекции. Пример
![img_1.png](img_1.png)
